<?php
require_once '../../Controllers/CustomerController.php'; // Include your PHP file where the CategoryController class is defined

$CustomerController = new CustomerController(); // Create an instance of CategoryController
$Customers = $CustomerController->getAllDeactiveCustomers();
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Active'])) {
    ...
    if (!empty($CustomerID)) {
        ...
        $CustomerController->ActiveCustomer($CustomerID);
        // Redirect to the same page to refresh and show updated list
        header("Location: " . $_SERVER['PHP_SELF']);
        exit();
    } else {
        $errorMessage = "معرف العميل مطلوب.";
    }
}
?>
                                      ...
                                      <div class="table-responsive text-nowrap">
                                        <table class="table table-striped">
                                          ...
                                          <tbody class="table-border-bottom-0">
                                            ...
                                            <?php else: ?>
                                              <tr>
                                                <td colspan="3">لا يوجد عملاء حتي الان</td>
                                              </tr>
                                            <?php endif; ?>
                                          </tbody>
                                        </table>
