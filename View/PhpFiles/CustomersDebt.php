...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get the selected CustomerID from the form submission
    if (!empty($_POST['CustomerId'])){
    $selectedCustomerID = $_POST['CustomerId'];

    // Redirect to the desired page with the selected CustomerID
    header("Location: CustomersPayDebt.php?CustomerID=" . htmlspecialchars($selectedCustomerID));
    exit();
    }
    else{
      $errorMessage = "الرجاء وضع اسم العميل";
    }
}
?>
<!DOCTYPE html>
                                    ...
                                    <div class="col-xl">
                                        <div class="card mb-4">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <h5 class="mb-0">تحصيل العملاء</h5>
                                            </div>
                                            <div class="card-body">
                                                <form method="POST" action="">
                                                    ...
                                                    <div class="mt-3">
                                                        <button type="submit" class="btn rounded-pill btn-success" name="search">تحصيل</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
