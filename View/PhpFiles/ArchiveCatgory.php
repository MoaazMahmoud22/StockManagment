...
$categories = $categoryController->getAllArchiveCategories();
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Active'])) {
    ...
    $categoryId = trim($_POST['CustomerId']);

    if (!empty($categoryId)) {
        // Call the deleteCategory function from CategoryController
        $categoryController->ActiveCategory($categoryId);
                                      ...
                                      <div class="table-responsive text-nowrap">
                                        <table class="table table-striped">
                                          ...
                                          <tbody class="table-border-bottom-0">
                                                    ...
                                                    <div class="dropdown">
                                                      ...
                                                      <div class="dropdown-menu">
                                                        ...
                                                        <form method="post" action="" style="display: inline;">
                                                          ...
                                                          <button type="submit" class="dropdown-item" name="Active" onclick="return confirm('Are you sure you want to delete this category?');">
                                            ...
                                            <?php else: ?>
                                              <tr>
                                                <td colspan="3">لا يوجد اصناف حتي الان</td>
                                              </tr>
                                            <?php endif; ?>
                                          </tbody>
                                        </table>
